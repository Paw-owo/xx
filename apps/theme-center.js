...
function handleShareTheme(themeId) {
  ...
  setStatus(`已经打包好：${result.package.shareInfo.themeName}`);
}
...
function injectStyle() {
  ...
  styleEl.textContent = `
    ...
    .theme-center::before{content:'';position:absolute;inset:0;background:radial-gradient(circle at top left,color-mix(in srgb,var(--accent-light) 36%,transparent),transparent 42%);pointer-events:none}.theme-center-nav{position:relative;z-index:1;display:flex;align-items:center;gap:var(--spacing-sm);padding:14px 16px 8px}.theme-center-back,.theme-center-action,.theme-center-mini{border:0;border-radius:var(--radius-full);background:var(--bg-card);color:var(--text-primary);box-shadow:var(--shadow-sm);font:inherit;display:inline-flex;align-items:center;justify-content:center;gap:6px}.theme-center-back{min-width:92px;padding:9px 12px}.theme-center-title{min-width:0}.theme-center-title .nav-title{font-weight:800}.theme-center-title .nav-subtitle{font-size:12px;color:var(--text-secondary)}
    .theme-center-content{position:relative;z-index:1;flex:1;overflow:auto;padding:8px 14px 24px}.theme-center-room{max-width:980px;margin:0 auto;display:flex;flex-direction:column;gap:14px}.theme-center-hero,.theme-center-card,.theme-center-preview-note{border:1px solid var(--border-soft);border-radius:var(--radius-lg);background:color-mix(in srgb,var(--bg-card) 92%,transparent);box-shadow:var(--shadow-card);padding:16px;backdrop-filter:blur(14px)}.theme-center-hero{display:flex;align-items:flex-end;justify-content:space-between;gap:var(--spacing-md)}.theme-center-hero h2{margin:4px 0;font-size:24px}.theme-center-hero p,.theme-center-soft,.theme-center-theme span,.theme-center-theme small,.theme-center-preview-note span{color:var(--text-secondary);font-size:13px}.theme-center-hero small{color:var(--accent-dark);font-weight:700}.theme-center-actions{display:flex;gap:8px;flex-wrap:wrap}.theme-center-action{padding:10px 13px}.theme-center-mini{padding:7px 10px;font-size:12px}.theme-center-import-file,.theme-center-none{display:none}
    .theme-center-preview-note{display:flex;align-items:center;justify-content:space-between;gap:var(--spacing-sm)}.theme-center-sections{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.theme-center-card{display:flex;flex-direction:column;gap:10px}.theme-center-card h3{margin:0;font-size:17px}.theme-center-soft{margin:0}.theme-center-theme-list{display:flex;flex-direction:column;gap:10px}.theme-center-theme{display:grid;grid-template-columns:auto minmax(0,1fr);gap:10px;border-radius:var(--radius-md);background:color-mix(in srgb,var(--bg-secondary) 62%,transparent);padding:10px}.theme-center-theme.is-active{outline:2px solid color-mix(in srgb,var(--accent) 44%,transparent)}.theme-center-theme-body{display:flex;flex-direction:column;gap:3px;min-width:0}.theme-center-theme .theme-center-actions{grid-column:1 / -1}.theme-center-cover{width:58px;height:58px;border-radius:var(--radius-md);background:linear-gradient(145deg,var(--room-bg),var(--room-card));border:1px solid var(--border-soft);box-shadow:var(--shadow-sm);position:relative;overflow:hidden}.theme-center-cover i,.theme-center-cover b,.theme-center-cover em{position:absolute;display:block;border-radius:var(--radius-full)}.theme-center-cover i{inset:11px;background:var(--room-card)}.theme-center-cover b{width:18px;height:18px;right:8px;bottom:8px;background:var(--room-accent)}.theme-center-cover em{width:9px;height:9px;left:10px;top:10px;background:color-mix(in srgb,var(--room-accent) 48%,var(--bg-card))}
