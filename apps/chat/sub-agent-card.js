...
function injectStyle() {
  ...
  style.id = STYLE_ID;
  style.textContent = `
    .chat-sub-agent-card{min-width:min(260px,72vw);max-width:100%;border-radius:var(--radius-lg);background:color-mix(in srgb,var(--bg-card) 88%,transparent);box-shadow:var(--shadow-sm);overflow:hidden;border:1px solid color-mix(in srgb,var(--border-soft) 62%,transparent)}
    ...
    .chat-sub-agent-mark{width:34px;height:34px;border-radius:14px;display:inline-flex;align-items:center;justify-content:center;color:var(--ai-companion-decoration,var(--accent));background:color-mix(in srgb,var(--accent-light) 28%,var(--bg-card));background-image:var(--ai-companion-decoration-image,none);background-size:cover;background-position:center}
    .chat-sub-agent-mark svg{width:23px;height:23px;fill:currentColor;opacity:.86}
    .chat-sub-agent-head-text{min-width:0;display:flex;flex-direction:column;gap:3px}.chat-sub-agent-title{font-size:14px;font-weight:700;color:var(--text-primary)}.chat-sub-agent-summary,.chat-sub-agent-meta{font-size:12px;color:var(--text-secondary);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.chat-sub-agent-meta{color:var(--text-hint)}.chat-sub-agent-chevron{font-size:19px;color:var(--text-hint);transition:transform 180ms ease}.chat-sub-agent-card[data-open="true"] .chat-sub-agent-chevron{transform:rotate(90deg)}
    .chat-sub-agent-detail{display:flex;flex-direction:column;gap:9px;padding:0 12px 12px}.chat-sub-agent-detail[hidden]{display:none}.chat-sub-agent-block{border-radius:var(--radius-md);background:color-mix(in srgb,var(--surface-muted) 82%,transparent);padding:10px}.chat-sub-agent-block-title{font-size:12px;font-weight:700;color:var(--text-primary);margin-bottom:5px}.chat-sub-agent-block-text{font-size:12px;line-height:1.6;color:var(--text-secondary);white-space:pre-wrap;word-break:break-word}
  `;
