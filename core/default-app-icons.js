...
const ICON_DRAWINGS = {
  chat: `
    ...
    <path class="charm" d="M63 62c5 0 9 4 9 9s-4 9-9 9-9-4-9-9 4-9 9-9Z"/><path class="line-only" d="m59 71 3 3 6-7"/><path class="ribbon" d="M35 63c-8-6-15-1-12 7 2 6 9 4 14-1 5 5 12 7 14 1 3-8-4-13-12-7Z"/><circle class="charm" cx="37" cy="66" r="3"/>`,
  moments: `
  ...
  gallery: `
    <path class="paper" d="M17 25h62v56H17Z"/><path class="soft" d="M23 31h50v44H23Z"/><path class="fur" d="M25 66 39 52l10 8 14-19 9 25v7H25Z"/>
  ...
  characters: `
    <path class="fur" d="M18 49V31l12 8c5-5 11-7 18-7s13 2 18 7l12-8v18c0 17-12 28-30 28S18 66 18 49Z"/><path class="patch" d="M61 36c8 3 12 9 11 18-8 1-14-2-17-9 1-4 3-7 6-9Z"/>
    ...
    <path class="ribbon" d="M39 68c3 3 6 3 9 0 3 3 6 3 9 0"/><circle class="charm" cx="48" cy="68" r="3"/><path class="sparkle" d="m75 22 1.5 3.5L80 27l-3.5 1.5L75 32l-1.5-3.5L70 27l3.5-1.5Z"/>`,
  worldbook: `
  ...
  shop: `
    <path class="paper" d="M20 36h56l-5 49H25Z"/><path class="awning" d="M16 36h64l-8-18H24Z"/><path class="fur" d="M28 52h40l5 33H23Z"/><path class="line-only" d="M34 36c0-11 5-18 14-18s14 7 14 18"/>
  ...
  memo: `
    <path class="paper" d="M22 14h48l10 10v60H22Z"/><path class="soft" d="M28 23h36v54H28Z"/><path class="highlight" d="M70 14v12h10M34 39h27M34 52h23M34 65h17"/>
  ...
  anniversary: `
    <path class="paper" d="M16 32h64v52H16Z"/><path class="soft" d="M23 50h50v27H23Z"/><path class="fur" d="M16 32h64v14H16ZM30 27v12m36-12v12"/>
  ...
  music: `
    <path class="highlight" d="M18 51c0-14 11-25 25-25s25 11 25 25-11 25-25 25-25-11-25-25Z"/><path class="ribbon" d="M60 22c5-6 13-4 13 3s-8 9-13 4c-5 5-13 3-13-4s8-9 13-3Z"/><path class="paper" d="M31 51c0-7 5-12 12-12s12 5 12 12-5 12-12 12-12-5-12-12Z"/>
...
export function createDefaultAppIcon(app, size = 28, documentRef = document) {
  ...
  svg.innerHTML = `<g class="icon-badge-frame" aria-hidden="true">
      <path class="badge-paper" d="M13 22c2-7 8-9 14-6 3-7 12-8 18-3 6-5 15-4 18 3 6-3 12-1 15 6 7 2 10 10 6 16 5 6 4 14-3 18 2 8-4 15-12 15-4 7-13 8-19 3-6 5-15 4-19-3-8 0-14-7-12-15-7-4-8-12-3-18-4-6-1-14 6-16Z"/>
